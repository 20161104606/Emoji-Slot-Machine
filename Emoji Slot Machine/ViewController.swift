...
//  Emoji Slot Machine
//
//  Created by nimo on 2018/12/26.
//  Copyright © 2018年 nimoAndHisFriends. All rights reserved.
//
...
class ViewController: UIViewController,UIPickerViewDelegate,UIPickerViewDataSource {
    ...
    @objc func goAction() {
        ...
        slotMachine.selectRow(Int(arc4random())%(emojiArray.count - 2) + 1, inComponent: 2,
                               : true)
